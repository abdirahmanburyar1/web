...
export function PlatformSidebar({
  ...
  const linkClass = (active: boolean) =>
    `flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 ${
      active
        ? "bg-cyan-500/12 text-cyan-800 shadow-sm border-l-[3px] border-cyan-500"
    ...
    <>
      ...
      >
        <div className="flex h-16 items-center gap-3 border-b border-slate-200/80 px-5 bg-white/50">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-cyan-500 text-white font-bold text-sm shadow-md">
            A
          </div>
          <div>
